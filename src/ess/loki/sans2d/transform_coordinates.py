...
def setup_offsets(sample, background, sample_trans, background_trans, direct_beam):
    # TODO: check this positions
    sample_pos_z_offset = 0.053 * sc.units.m
    bench_pos_y_offset = 0.00019 * sc.units.m
    monitor4_pos_z_offset = -0.055 * sc.units.m

    for item in [sample, background, sample_trans, background_trans, direct_beam]:
