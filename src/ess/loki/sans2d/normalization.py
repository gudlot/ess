...
def transmission_fraction(sample, background, direct, wavelength_bins, min_bin, max_bin):
    """
    ...
    sample_incident = setup(sample.attrs['monitor2'].value,  min_bin, max_bin, scatter=False)
    sample_trans = setup(sample.attrs['monitor4'].value, min_bin, max_bin, scatter=False)
    direct_incident = setup(direct.attrs['monitor2'].value, min_bin, max_bin, scatter=False)
    direct_trans = setup(direct.attrs['monitor4'].value, min_bin, max_bin, scatter=False)
