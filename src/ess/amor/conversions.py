...
def incident_beam(*, source_chopper_1: sc.Variable, source_chopper_2: sc.Variable,
    ...
    """
    chopper_midpoint = (source_chopper_1.value['position'].data + source_chopper_2.value['position'].data) * sc.scalar(0.5)
