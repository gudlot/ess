    ...
    beamline["chopper_wfm_1"] = sc.scalar(
        sc.Dataset(
            data={
                ...
                sc.array(
                    dims=[dim],
                    values=np.array([83.71, 140.49, 193.26, 242.32, 287.91, 330.3]) +
                    15.0,
                    unit='deg'),
                "cutout_angles_end":
                sc.array(
                    dims=[dim],
                    values=np.array([94.7, 155.79, 212.56, 265.33, 314.37, 360.0]) +
                    15.0,
                    unit='deg'),
                "kind":
                sc.scalar('wfm')
    ...
    beamline["chopper_wfm_2"] = sc.scalar(
        sc.Dataset(
            data={
                ...
                sc.array(
                    dims=[dim],
                    values=np.array([65.04, 126.1, 182.88, 235.67, 284.73, 330.32]) +
                    15.0,
                    unit='deg'),
                "cutout_angles_end":
                sc.array(
                    dims=[dim],
                    values=np.array([76.03, 141.4, 202.18, 254.97, 307.74, 360.0]) +
                    15.0,
                    unit='deg'),
                "kind":
                sc.scalar('wfm')
    ...
    beamline["chopper_foc_1"] = sc.scalar(
        sc.Dataset(
            data={
                ...
                sc.array(
                    dims=[dim],
                    values=np.array([64.35, 125.05, 183.41, 236.4, 287.04, 335.53]) +
                    15.0,
                    unit='deg'),
                "cutout_angles_end":
                sc.array(
                    dims=[dim],
                    values=np.array([84.99, 148.29, 205.22, 254.27, 302.8, 360.0]) +
                    15.0,
                    unit='deg'),
                "kind":
                sc.scalar("frame_overlap")
            }))
    beamline["chopper_foc_2"] = sc.scalar(
        sc.Dataset(
            data={
                "frequency":
                sc.scalar(28.0, unit="Hz"),
                "phase":
                ...
                sc.array(
                    dims=[dim],
                    values=np.array([79.78, 136.41, 191.73, 240.81, 287.13, 330.89]) +
                    15.0,
                    unit='deg'),
                "cutout_angles_end":
                sc.array(
                    dims=[dim],
                    values=np.array([116.38, 172.47, 221.94, 267.69, 311.69, 360.0]) +
                    15.0,
                    unit='deg'),
                "kind":
                sc.scalar("frame_overlap")
