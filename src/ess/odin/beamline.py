...
def make_beamline() -> dict:
    ...
    beamline["chopper_wfm_1"] = sc.scalar(
        sc.Dataset(
            data={
                ...
                "phase":
                sc.scalar(0.0, unit='deg'),
                "position":
                sc.vector(value=[0, 0, 6.775], unit='m'),
    ...
    beamline["chopper_wfm_2"] = sc.scalar(
        sc.Dataset(
            data={
                ...
                sc.scalar(0.0, unit='deg'),
                "position":
                sc.vector(value=[0, 0, 7.225], unit='m'),
                "cutout_angles_center":
                sc.array(dims=[dim],
    ...
    beamline["chopper_foc_1"] = sc.scalar(
        sc.Dataset(
            data={
                "frequency":
                sc.scalar(42.0, unit="Hz"),
                "phase":
                sc.scalar(0.0, unit='deg'),
                "position":
                sc.vector(value=[0, 0, 8.4], unit='m'),
                "cutout_angles_center":
                sc.array(dims=[dim],
    ...
    beamline["chopper_foc_2"] = sc.scalar(
        sc.Dataset(
            data={
                ...
                sc.scalar(0.0, unit='deg'),
                "position":
                sc.vector(value=[0, 0, 12.20], unit='m'),
                "cutout_angles_center":
                sc.array(dims=[dim],
    ...
    beamline["chopper_foc_3"] = sc.scalar(
        sc.Dataset(
            data={
                ...
                sc.scalar(0.0, unit='deg'),
                "position":
                sc.vector(value=[0, 0, 17.0], unit='m'),
                "cutout_angles_center":
                sc.array(dims=[dim],
    ...
    beamline["chopper_foc_4"] = sc.scalar(
        sc.Dataset(
            data={
                ...
                sc.scalar(0.0, unit='deg'),
                "position":
                sc.vector(value=[0, 0, 23.69], unit='m'),
                "cutout_angles_center":
                sc.array(dims=[dim],
    ...
    beamline["chopper_foc_5"] = sc.scalar(
        sc.Dataset(
            data={
                ...
                sc.scalar(0.0, unit='deg'),
                "position":
                sc.vector(value=[0, 0, 33.0], unit='m'),
                "cutout_angles_center":
                sc.array(dims=[dim],
